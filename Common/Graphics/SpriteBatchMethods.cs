...
{
    internal class SpritebatchMethods
    {
        public static FastFieldInfo<SpriteBatch, bool> beginCalled { get; private set; } = new(
            "beginCalled", System.Reflection.BindingFlags.NonPublic);
        public static FastFieldInfo<SpriteBatch, SpriteSortMode> sortMode { get; private set; } = new(
            "sortMode", System.Reflection.BindingFlags.NonPublic);
        public static FastFieldInfo<SpriteBatch, Effect> customEffect { get; private set; } = new(
            "customEffect", System.Reflection.BindingFlags.NonPublic);
        public static FastFieldInfo<SpriteBatch, Matrix> transformMatrix { get; private set; } = new(
            "transformMatrix", System.Reflection.BindingFlags.NonPublic);
    }
