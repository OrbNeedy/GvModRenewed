...
namespace GvMod.Common.UI
{
    public class APBar : UIElement
    {
        ...
        public override void OnInitialize()
        {
            ...
            {
                barFilling[i] = new UIImageFramed(fillingTexture, new Rectangle(0, 0, 10, 20));
                barFilling[i].Left.Set(4, 0f);
                barFilling[i].Top.Set(6, 0f);
                barFilling[i].Width.Set(10, 0f);
                barFilling[i].Height.Set(20, 0f);

                barFilled[i] = new UIImage(fullTexture);
                barFilled[i].Left.Set(2, 0f);
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            for (int i = 0; i < barFilling.Length; i++)
            {
                ...
                {
                    barFilling[i].SetFrame(new Rectangle(0, 0, 10, (int)(20 * barAP)));
