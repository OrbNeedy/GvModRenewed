...
{
    class ZombieIceBat : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main._rand.NextBool(20))
            {
                for (int i = 0; i < 2; i++)
                {
                    int id = Dust.NewDust(Projectile.Center - (Projectile.Size / 2), Projectile.width,
                        Projectile.height, DustID.IceRod);
