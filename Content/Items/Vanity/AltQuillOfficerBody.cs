...
namespace GvMod.Content.Items.Vanity
{
    [AutoloadEquip(EquipType.Body)]
    public class AltQuillOfficerBody : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            ItemID.Sets.ShimmerTransformToItem[Item.type] = ModContent.ItemType<QuillOfficerBody>();
        }
